...
class TestSmokeTest():
  ...
  def test_navigatetothehomepage(self):
    ...
    self.driver.set_window_size(1292, 700)
  ...
  def test_navigatetothejoinpage(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").click()
    self.driver.find_element(By.NAME, "fname").send_keys("Simon")
    self.driver.find_element(By.NAME, "lname").click()
    self.driver.find_element(By.NAME, "lname").send_keys("Mule")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("Simy innovations")
    self.driver.find_element(By.NAME, "biztitle").click()
    self.driver.find_element(By.NAME, "biztitle").send_keys("Legend")
